...
public class ServiceErrorResponse {
    ...
    public static final String PROPERTY_NAME_DISABLE_STACK_TRACE_COLLECTION = Utils.PROPERTY_NAME_PREFIX
            + "ServiceErrorResponse.disableStackTraceCollection";

    public static final boolean DISABLE_STACK_TRACE_COLLECTION = Configuration.bool(
