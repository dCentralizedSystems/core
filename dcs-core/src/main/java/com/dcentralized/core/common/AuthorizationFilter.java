...
import com.dcentralized.core.services.common.authz.AuthorizationConstants;
...
public class AuthorizationFilter implements Filter {
    ...
    private void verifyToken(Operation op, OperationProcessingContext context,
        ...
        if (basicAuthenticationServiceUri == null
                || basicAuthenticationServiceUri.equals(host.getAuthenticationServiceUri())) {
