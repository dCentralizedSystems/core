...
import static com.dcentralized.core.common.config.ConfigurationSource.subsystemToString;
...
public final class Configuration {
    ...
    private static final Configuration INSTANCE = new Configuration(new ConfigurationSource());
     ...
     * @see Configuration#integer(Class, String, long)
     * @param subsystem
     * @param property
     * @param defaultValue
     * @return
