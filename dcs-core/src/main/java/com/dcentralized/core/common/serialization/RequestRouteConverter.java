...
public enum RequestRouteConverter implements JsonSerializer<Route>, JsonDeserializer<Route> {
     ...
     * For RequestBodyMatcher ex: {"action":"PATCH","condition":"com.dcentralized.core.common.RequestBody#kind=X",
        ...
        try {
            ...
            if (!isNullOrEmpty(condition)) {
                ...
                if (condition.startsWith("?")) {
                    ...
                    String[] bodyParts = conditionParts[1].split(String.valueOf(UriUtils.URI_QUERY_PARAM_KV_CHAR));
