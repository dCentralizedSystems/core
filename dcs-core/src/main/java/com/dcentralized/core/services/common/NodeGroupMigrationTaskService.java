...
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.CURRENT_BATCH_FINISHED_WITH_FAILURE;
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.CURRENT_BATCH_FINISHED_WITH_SUCCESS;
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.MIGRATE_CURRENT_BATCH;
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.MOVE_TO_NEXT_BATCH;
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.POST_BATCH_COMPLETION;
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.PREPARE_CURRENT_BATCH;
import static com.dcentralized.core.services.common.NodeGroupMigrationTaskService.SubStage.WAITING_BATCH_TO_FINISH;
...
import com.dcentralized.core.services.common.NodeGroupMigrationTaskService.NodeGroupMigrationState;
import com.dcentralized.core.services.common.NodeGroupMigrationTaskService.NodeGroupMigrationState.MigrationRequest;
import com.dcentralized.core.services.common.NodeGroupMigrationTaskService.NodeGroupMigrationState.ResultReport;

/**
 * Handle node group to node group migration.
 *
                ...
                Operation.createGet(task.sourceNodeReference)
                        .setCompletion((op, ex) -> {
                            ...
                            if (ex != null) {
                                ...
                                getHost().queryServices(null, EnumSet.of(ServiceOption.FACTORY),
                                        null, UriUtils.URI_WILDCARD_CHAR, callback);
                            } else {
