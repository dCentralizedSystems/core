...
import com.dcentralized.core.common.NodeSelectorService;
...
import com.dcentralized.core.common.http.netty.NettyChannelContext;
...
import com.dcentralized.core.services.common.NodeState.NodeStatus;
...
public class VerificationHost extends ExampleServiceHost {
    ...
    * Returns true if host restarted, false if retry attempts expired or other exceptions where thrown
    ...
    public List<String> getServicePathsByPrefix(String servicePathPrefix) {
        ...
        this.queryServices(UriUtils.buildUriPath(servicePathPrefix, UriUtils.URI_WILDCARD_CHAR),
                dummy);
    ...
    public VerificationHost getNonOwnerPeer(String path, String nodeSelectorPath) {
        return getInProcessHostMap().values().stream()
                ...
                .findFirst()
                .orElseThrow(() -> new RuntimeException("couldn't find non-owner node"));
    }
