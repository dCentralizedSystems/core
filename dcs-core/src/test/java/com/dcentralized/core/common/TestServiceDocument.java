...
import com.dcentralized.core.common.Utils.MergeResult;
import com.dcentralized.core.common.test.ExampleService;
import com.dcentralized.core.services.common.QueryTask;
import com.dcentralized.core.services.common.QueryValidationTestService;
...
public class TestServiceDocument {
    ...
    public void copyTo() throws Throwable {
        ...
        assertEquals(25, ServiceDocument.class.getFields().length);
