...
import com.dcentralized.core.common.QueryTaskClientHelper;
...
public class TestInterleavedQueries extends BasicReusableHostTestCase {
    ...
    public void testSearcherReuse() throws Throwable {
        ...
        for (int i = 0; i < this.serviceCount; i++) {
            ExampleServiceState doc = createBigState(keys);
            Operation postDocument = Operation
                    .createPost(UriUtils.buildUri(this.host, ExampleService.FACTORY_LINK))
                    .setBody(doc);
        ...
        for (i = 0; i < this.requestCount; i++) {
            ...
            task.documentExpirationTimeMicros = Utils
                    .fromNowMicrosUtc(TimeUnit.MINUTES.toMicros(30));

            Operation postTask = Operation
